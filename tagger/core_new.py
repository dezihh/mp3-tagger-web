...
class MusicTagger:
    ...
    def embed_cover_art(self, file_path, cover_data, mime_type='image/jpeg'):
        """
        Bettet Cover-Bild in MP3-Datei ein
        
        Args:
            file_path (str): Pfad zur MP3-Datei
            cover_data (bytes): Binärdaten des Cover-Bildes
            mime_type (str): MIME-Type des Bildes
        ...
        try:
            ...
            audio.tag.images.set(
                type_=eyed3.id3.frames.ImageFrame.FRONT_COVER,
                img_data=cover_data,
                mime_type=mime_type,
                description="Cover"
            )
